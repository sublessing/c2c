  ...
  <div class="app-container">
    <el-form :inline="true" :model="queryParams" label-width="80px" size="mini">
      ...
      <el-form-item>
        ...
        <el-button type="primary" @click="handleDownload" v-if="this.urls.includes('/statistics/alipay_day/excel/')" :loading="downloadLoading">导出</el-button>
      </el-form-item>
    </el-form>
...
import { listDayAlipay, dayAlipayExcel } from '@/api/stat'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      listDayAlipay(this.queryParams).then(response => {
    ...
    handleDownload() {
      ...
      dayAlipayExcel(this.queryParams).then(response => {
        ...
        require.ensure([], () => {
          ...
          export_json_to_excel(tHeader, data, '支付宝日报')
