  ...
  <div class="app-container">
    <el-form :inline="true" :model="queryParams" label-width="80px" size="mini">
      ...
      <el-form-item>
        ...
        <el-button type="primary" @click="handleDownload" v-if="this.urls.includes('/statistics/wx_day/excel/')" :loading="downloadLoading">导出</el-button>
      </el-form-item>
    </el-form>
...
import { listDayWx, dayWxExcel } from '@/api/stat'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      listDayWx(this.queryParams).then(response => {
    ...
    handleDownload() {
      ...
      dayWxExcel(this.queryParams).then(response => {
        ...
        require.ensure([], () => {
          ...
          export_json_to_excel(tHeader, data, '微信日报')
