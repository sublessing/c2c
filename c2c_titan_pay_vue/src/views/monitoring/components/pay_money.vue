<template>
  <div class="app-container">
    ...
    <div id="mpm" style="width:680px; height:250px;" v-loading="listLoading">
    </div>
  </div>
</template>
...
export default {
    ...
    methods: {
            ...
            successRateMerchantDraw(this.queryParams).then(response => {
                ...
                for (var name in response.data.yAxisData) {
                  ...
                  this.seriesData.push({
                    ...
                    type: 'line',
                    data: response.data.yAxisData[name].map(el => el.order_money || 0)
                  })
                }
        ...
        intiChart(){
          var _self = this;
          this.chart = echarts.init(document.getElementById('mpm'))
          const option = {
            tooltip: {
              trigger: 'axis',
              axisPointer: {
