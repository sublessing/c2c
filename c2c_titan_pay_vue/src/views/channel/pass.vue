  ...
  <div class="app-container">
    ...
    <el-dialog :title="titleMap[dialogStatus]" :visible.sync="createVisible" width="30%" v-draggable>
      <el-form class="small-space" :model="form" ref="form" :rules="rules" label-position="left" label-width="120px">
        ...
        <el-form-item label="每日限额" prop="max_money">
          <el-input v-model="form.max_money" placeholder="请输入每日限额"></el-input>
        </el-form-item>
        <el-form-item label="费率" prop="way_rate">
          <el-input v-model="form.way_rate" placeholder="请输入收支差"></el-input>
        </el-form-item>
        <el-form-item label="权重系数" prop='way_weight'>
          <el-input v-model="form.way_weight" placeholder="请输入适配器地址"></el-input>
        </el-form-item>
...
import { listSelectChannel, listWay, addWay, editWay, editWayStatus } from '@/api/service'
export default {
    name: 'Channel',
    data(){
        ...
        var rateValidate = (rule, value, callback) => {
