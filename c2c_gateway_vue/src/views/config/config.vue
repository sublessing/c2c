  ...
  <div class="app-container">
    ...
    <el-table :cell-style="cellStyle" :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中"  border stripe fit highlight-current-row size="small">
      ...
      <el-table-column align="center" label="操作" width="160px">
        <template slot-scope="scope">
          <el-button v-show="scope.row.edit" type="danger" size="mini" @click="doSubmit(scope.row)">保存</el-button>
          <el-button v-show="scope.row.edit" type="" size="mini" @click="doCancel(scope.row)">取消</el-button>
          <el-button v-show="!scope.row.edit" type="primary" size="mini" @click="doEdit(scope.row)">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { updateConfig, listConfig, reloadConfig } from '@/api/service'
