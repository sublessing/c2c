<template>
  <div class="app-container">
    ...
    <div id="mpb" style="width:680px; height:250px;" v-loading="listLoading">
    </div>
  </div>
</template>
...
import { merchantBalance } from '@/api/service'
...
export default {
    ...
    methods: {
        ...
        fetchData(){
            ...
            merchantBalance(this.queryParams).then(response => {
                this.seriesData = []
                this.legendData = [];
        ...
        intiChart(){
          var _self = this;
          this.chart = echarts.init(document.getElementById('mpb'))
          const option = {
            tooltip: {
              trigger: 'axis',
              axisPointer: {
